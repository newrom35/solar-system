sphere.prototype = new worldObject;
	function sphere(parent,texture,rotation)
	{
		this.base = worldObject;
		this.base(parent,texture,rotation);
		...
		this.vertexNormalBuffer = buffers[0];
	}
	...
	sphere.prototype.initBuffers = function()
	{
		...
		for (var lat=-90; lat <= phiMax; lat+=pasLat)
		{
			for (var longi=0; longi <= tetaMax; longi+=pasLong)
            {
				...
				normales = normales.concat(vertices[lat,longi]);
